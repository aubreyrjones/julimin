...
# chip specific
set(COMMON_EMBED_OPTIONS "-march=armv6-m -mtune=cortex-m0plus -mthumb -mfloat-abi=soft -T ${CMAKE_CURRENT_SOURCE_DIR}/chips/kl26z/memory_map.ld")

add_definitions(-D__MKL26Z64__)
include_directories(chips/kl26z)
SET(NOS_CHIP_FILES
        chips/kl26z/core.c)